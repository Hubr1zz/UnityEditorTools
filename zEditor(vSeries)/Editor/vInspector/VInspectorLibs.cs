...
namespace VInspector.Libs
{
    public static class VUtils
    {
        ...
        {
#if UNITY_6000_3_OR_NEWER
            return GlobalObjectId.GlobalObjectIdentifierToEntityIdSlow(id).ToLegacyInstanceId();
#else
        ...
        static void _GlobalObjectId_GlobalObjectIdentifiersToInstanceIDsSlow(GlobalObjectId[] identifiers, int[] outputInstanceIDs)
        {
            ...
            for (int i = 0; i < outputEntityIds.Length; i++)
                outputInstanceIDs[i] = outputEntityIds[i].ToLegacyInstanceId();
#else
        ...
        public static int[] _Selection_instanceIDs
        {
            ...
            {
#if UNITY_6000_3_OR_NEWER
                return Selection.entityIds.Select(r => r.ToLegacyInstanceId()).ToArray();
#else
